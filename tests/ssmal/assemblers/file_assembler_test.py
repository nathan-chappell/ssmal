...
@pytest.mark.parametrize(
    ...
    [
        ("""tests\\ssmal\\test_samples\\file_assembler\\unexpected_token\\include_arg.al""", UnexpectedTokenError),
        ("""tests\\ssmal\\test_samples\\file_assembler\\unexpected_token\\filename.al""", UnexpectedTokenError),
    ],
)
