.goto 0 bri $Program.main ; start
.goto 0x20 "TYPEINFO" .align
"int" .align
int.vtable:
"str" .align
str.vtable:
...
Pair.methods:
    Pair.sum:
        ldai 0 ; create space on stack for locals
        ...
        ldai 0 psha ; create space on stack for locals
            ...
            ; stmt Expr stmt.lineno=6
                ; expr Call expr.lineno=6
                    ; expr Call expr.lineno=6
                    swpai psha swpai ; save return address
