...
double_counter_expected = [
    ...
    TmTransition(cur_state="check_input__first_2s", cur_symbol="1", next_state="check_input__second_1s", next_symbol="1", move_head="R"),
    TmTransition(cur_state="check_input__second_1s", cur_symbol="1", next_state="check_input__second_1s", next_symbol="1", move_head="R"),
    TmTransition(cur_state="check_input__second_1s", cur_symbol="2", next_state="check_input__second_2s", next_symbol="2", move_head="R"),
    TmTransition(cur_state="check_input__second_2s", cur_symbol="2", next_state="check_input__second_2s", next_symbol="2", move_head="R"),
    ...
    TmTransition(cur_state="erase_1__return_right", cur_symbol="0", next_state="erase_1__check_1_on_right", next_symbol="0", move_head="L"),
    TmTransition(
    ...
    TmTransition(cur_state="erase_2__return_left", cur_symbol="1", next_state="erase_2__check_2_on_right", next_symbol="0", move_head="R"),
    TmTransition(
