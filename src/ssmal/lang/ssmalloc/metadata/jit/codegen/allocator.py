...
class TrivialAllocator:
    ...
    def __init__(
        self, string_table: StringTable, type_dict: OrderedDict[TypeName, TypeInfo], label_maker: LabelMaker
    ) -> None:
    ...
    def create_heap(self, w: LineWriter, size=0x400) -> None:
        ...
        # assume A holds size we need to allocate, ret is on stack
        ...
        w.write_line(ci.POPA, ci.BRa, ci.COMMENT('return'))
